...
This class is used to display a bullet that moves with a standard amount of pixels per iteration and can kill mobs when it hits one
...
This constructor intializes the class. It receives the position of the bullet, a filename to use for loading the image, a list of all mobs in a level and a list of all walls in a level.
