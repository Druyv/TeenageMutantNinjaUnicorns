...
{   
    lower_wall = std::make_shared<wall>(
            sf::Vector2f{1000, screen_size.y},
            sf::Vector2f{screen_size.x, 20},
            sf::Color::Transparent
    );
    right_wall = std::make_shared<wall>(
            sf::Vector2f{screen_size.x+980, 420},
            sf::Vector2f{20, screen_size.y-420},
            sf::Color::Transparent
    );
    upper_wall = std::make_shared<wall>(
            sf::Vector2f{1000,400},
            sf::Vector2f{screen_size.x, 20},
            sf::Color::Transparent
    );
    left_wall = std::make_shared<wall>(
            sf::Vector2f{1000,420},
            sf::Vector2f{20, screen_size.y-420},
            sf::Color::Transparent
    );
